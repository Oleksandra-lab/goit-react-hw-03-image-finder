...
export class App extends Component {
  ...
  fetchAllImages = async () => {
    ...
    try {
      ...
      this.setState(prevState => ({images: [...prevState.images, ...hits], totalResults: totalHits}) );
  ...
  render() {
    ...
    return (
      <StyledApp>
        ...
        {images.length<totalResults && <Button onClick={this.onLoadMoreClick}>Load more</Button>}
        {isOpenModal&&<Modal modalImg={modalImg} onCloseModal={this.onCloseModal}/>}
      </StyledApp>
    );
  }
}
